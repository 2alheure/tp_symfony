 ...
 */
final class Version20220330080453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE classe (id INT AUTO_INCREMENT NOT NULL, prof_principal_id INT NOT NULL, nom VARCHAR(255) NOT NULL, niveau VARCHAR(5) NOT NULL, INDEX IDX_8F87BF968553BF90 (prof_principal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE note (id INT AUTO_INCREMENT NOT NULL, matiere_id INT NOT NULL, eleve_id INT NOT NULL, note DOUBLE PRECISION NOT NULL, coefficient DOUBLE PRECISION NOT NULL, date DATE NOT NULL, INDEX IDX_CFBDFA14F46CD258 (matiere_id), INDEX IDX_CFBDFA14A6CC7B2 (eleve_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
